            ...
            {projects.map((project, i) => (
                ...
                >
                    ...
                    <div
                        ...
                        className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-t-[28px] rounded-b-none border-t border-white/[0.12] border-x-0 border-b-0 bg-gradient-to-b from-[#161616] via-[#111111] to-black sm:rounded-t-[36px]"
                        style={{
