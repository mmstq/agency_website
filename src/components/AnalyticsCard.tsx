...
export default function AnalyticsCard() {
    return (
        <div className="w-full h-full min-h-[500px] p-6 bg-[#1a1a1a] rounded-3xl border border-white/5 shadow-2xl flex flex-col justify-between group hover:bg-[#202022] transition-colors duration-300">
            {/* Header Section */}
            ...
            <div className="relative w-full flex-grow flex items-center justify-center my-6 overflow-hidden">
                ...
                {/* Concentric Rings Construction (radar chart) */}
                <div className="relative flex items-center justify-center w-full aspect-square max-w-[220px]">
                    ...
                    <div className="absolute w-[80%] h-[80%] rounded-full border-4 border-white/10 flex items-center justify-center">
                        <div className="w-full h-full rounded-full border-4 border-white/40 border-t-white rotate-45 transition-transform duration-1000 group-hover:rotate-90"></div>
                    </div>
                    {/* Ring 3 */}
                    <div className="absolute w-[60%] h-[60%] rounded-full border-[6px] border-white/5 border-l-white/60 border-b-white/80 -rotate-12 transition-transform duration-1000 group-hover:rotate-12"></div>
                    {/* Ring 4 */}
